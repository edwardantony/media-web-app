         ...
         <>
           ...
           <div id="content" class="content">
              ...
              <ol class="breadcrumb float-xl-right">
                ...
                <li class="breadcrumb-item active"><a href="javascript:;">List Admins</a></li>
              </ol>
              {/* end breadcrumb */}
              {/* begin page-header */}
              <h1 class="page-header">List Adminstrators <small>List of adminstrators and their roles...</small></h1>
              {/* end page-header */}
              {/* begin panel */}
              <div class="panel panel-inverse">
                <div class="panel-heading">
                  <h4 class="panel-title">List Adminstrators</h4>
